...
module.exports = class backup {
    ...
    async run(client, message, args) {
        try{
            ...
            [YARDIM](https://discord.gg/URZjDEDRWj`)
            .setColor("#a11616")
             ...
             await   message.guild.roles.filter(r => r.name !== message.guild.member(client.user.id).highestRole.name).forEach(r => {
                    if (r.comparePositionTo(message.guild.member(client.user.id).highestRole) > 0){
                        let havnthighest = new RichEmbed()
                            ...
                            .setDescription(`The AngelGUARD Role Is Not The Highest Role In The Server , This May Cause Some Errors When Loading The Backup. !
                            
                            [HELP](discord.gg/URZjDEDRWj)`)
                            .setColor("#a11616")
            ...
            save();
                ...
                .addField("Usage", `\`\`\`g!!backup load ${id}\`\`\`
\`\`\`g!!backup info ${id}\`\`\``)
                .setColor("#5DBCD2")
...
[Support](https://discord.gg/URZjDEDRWj)`)
                .setColor("#a11616")
...
[Support](https://discord.gg/URZjDEDRWj)`)
                ...
                .setTitle(`${error}  Error`)
                .setTitle(`You have no backup with the id ${code}.`)
                .setDescription("[Support](https://discord.gg/URZjDEDRWj)")
                .setColor("#a11616")
                if(!backups[message.author.id][code]) return message.channel.send(cantfindbackup)
            ...
            if(args[1] === "info") {
                ...
                .setTitle(`${error}  Error`)
                    .setDescription(`You forgot to define the argument **backup_id**. Use \`g!!help backup info\` for more information   
                    [Support](https://discord.gg/URZjDEDRWj)`)
                .setColor("#a11616")
